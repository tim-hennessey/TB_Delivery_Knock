...
app.Animation = (function () {
    ...
    function initialize() {
        ...
        t.set(txt1, {transformOrigin: "50% 24%"});//horz vert
        t.set(txt2, {transformOrigin: "50% 40%"});
        t.set(txt3, {transformOrigin: "50% 60%"});
        t.set(txt4, {transformOrigin: "25% 70%"});
        t.set(txt5, {transformOrigin: "70% 70%"});
    ...
    function start() {
        ...
        tltxt.fromTo(txt1, .2, {opacity:0, scale: 0}, {opacity:1, scale:1.05, ease: Sine.easeInOut}, "+=.5")
            ...
            .fromTo(txt3, .25, {y:"+=40"}, {y:-3, ease: Sine.easeInOut}, "+=.5")
            .to(txt3, .15, {y:0, ease: Sine.easeInOut})

            .fromTo(txt4, .25, {y:"+=40"}, {y:-3, ease: Sine.easeInOut}, "-=.25")
            .to(txt4, .15, {y:0, ease: Sine.easeInOut})

            .fromTo(txt5, .25, {y:"+=40"}, {y:-3, ease: Sine.easeInOut}, "-=.25")
        ...
        tl6.to(cta, .25, {scale:1.05, ease: Sine.easeInOut}, "+=2")
            .to(cta, .15, {scale:.95, ease: Sine.easeInOut})
            .to(cta, .1, {scale:1, ease: Sine.easeIn});



        pintl.from(pin, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=3")
